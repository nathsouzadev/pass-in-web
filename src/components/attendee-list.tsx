    ...
    <div>
      <div className="flex gap-3 items-center">
        ...
        <div className="px-3 w-72 py-1.5 border border-white/10 rounded-lg text-sm flex items-center gap-3">
          ...
          <input className="bg-transparent flex-1 outline-none h-autp border-0 p-0 text-sm" placeholder="Buscar participante... "/>
        </div>
      </div>
      ...
      <table className="w-full">
        ...
        <tfoot>
          <tr>
            <td className="py-3 px-4 text-sm text-zinc-300" colSpan={3}>Mostrando 3 de 5 itens</td>
